...
using SpectatorClient.Login.RiotObjects.Platform.Broadcast;
using SpectatorClient.Login.RiotObjects.Platform.Systemstate;
using SpectatorClient.Login.RiotObjects.Kudos.Dto;
using SpectatorClient.Login.RiotObjects.Platform.Game;

namespace SpectatorClient.Login.RiotObjects.Platform.Clientfacade.Domain
{
