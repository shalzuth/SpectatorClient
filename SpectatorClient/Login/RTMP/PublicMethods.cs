...
using SpectatorClient.Login.RiotObjects;
using SpectatorClient.Login.RiotObjects.Leagues.Pojo;
using SpectatorClient.Login.RiotObjects.Platform.Catalog.Champion;
using SpectatorClient.Login.RiotObjects.Platform.Clientfacade.Domain;
using SpectatorClient.Login.RiotObjects.Platform.Game;
using SpectatorClient.Login.RiotObjects.Platform.Game.Practice;
using SpectatorClient.Login.RiotObjects.Platform.Harassment;
using SpectatorClient.Login.RiotObjects.Platform.Leagues.Client.Dto;
using SpectatorClient.Login.RiotObjects.Platform.Login;
using SpectatorClient.Login.RiotObjects.Platform.Matchmaking;
using SpectatorClient.Login.RiotObjects.Platform.Reroll.Pojo;
using SpectatorClient.Login.RiotObjects.Platform.Statistics;
using SpectatorClient.Login.RiotObjects.Platform.Statistics.Team;
using SpectatorClient.Login.RiotObjects.Platform.Summoner;
using SpectatorClient.Login.RiotObjects.Platform.Summoner.Boost;
using SpectatorClient.Login.RiotObjects.Platform.Summoner.Masterybook;
using SpectatorClient.Login.RiotObjects.Platform.Summoner.Runes;
using SpectatorClient.Login.RiotObjects.Platform.Summoner.Spellbook;
using SpectatorClient.Login.RiotObjects.Team;
using SpectatorClient.Login.RiotObjects.Team.Dto;
